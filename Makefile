...
PROJECT_REPO ?= github.com/bwi-de/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 2025.12.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-authentik
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/goauthentik/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-authentik
